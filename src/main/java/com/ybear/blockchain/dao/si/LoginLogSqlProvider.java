...
import com.ybear.blockchain.dao.model.LoginLogExample.Criteria;
import com.ybear.blockchain.dao.model.LoginLogExample.Criterion;
...
public class LoginLogSqlProvider {
    ...
    public String countByExample(LoginLogExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("b_login_log");
